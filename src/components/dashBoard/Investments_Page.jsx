  ...
  return (
    ...
    <div className='dash-table-wrap-one'>
      ...
      <table className='dash-table-one'>
        ...
        <tbody>
          {investmentData.map((val) => (
            <tr key={val.investorInfoID} className='table-data-row-one'>
              <td className='table-content-one'>{val.investmentName}</td>
              <td className='table-content-one'>{val.amount}</td>
              <td className='table-content-one'>{val.risk}</td>
              <td className='table-content-one'>{val.investmentType}</td>
